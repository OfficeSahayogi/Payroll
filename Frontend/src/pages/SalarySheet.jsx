  ...
  return (
    ...
    <div className="flex justify-between">
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto overflow-y-auto max-h-[300px] 2xl:max-h-[700px]">
          <table className="table-auto w-full border-collapse border border-gray-300 sticky top-0">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-300 px-4 py-2">Salary Type</th>
                <th className="border border-gray-300 px-4 py-2">Gross Salary</th>
                <th className="border border-gray-300 px-4 py-2">Total Days || Total Hours</th>
            ...
            <tbody>
              {salaryData.map((employee, index) => (
                <tr key={index}>
                  ...
                  <td className="border border-gray-300 px-4 py-2">{employee.salaryType}</td>
